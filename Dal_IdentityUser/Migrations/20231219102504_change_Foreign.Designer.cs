...
namespace DalBackup.Migrations
{
    ...
    [Migration("20231219102504_change_Foreign")]
    partial class change_Foreign
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DalBackup.Data.AdminLayout_VuexyUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "27fca573-bf42-449a-9fee-1ed31c2dc376",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a2a0b345-49cd-458e-bcf6-2e020f925be1",
                            Email = "thinh.nguyenngoc@vnresource.org",
                            EmailConfirmed = false,
                            LockoutEnabled = true,
                            NormalizedEmail = "THINH.NGUYENNGOC@VNRESOURCE.ORG",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEHuSDYTAkDibY4Mcuil9Nt1ksL4XDAYnK/hkQe0XgsSBzZsc2w/XiWUIGe6UwYFDKw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "742e6953-461f-4ec3-a15a-cd559c1b0545",
            ...
            modelBuilder.Entity("ModelProject.Models.Enum.Weekly", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2788), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Monday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2810), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 2
                        },
                        new
                        {
                            Id = new Guid("a1907086-a621-4a7f-9784-fe7a65a9b01a"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2816), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Tuesday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2816), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 4
                        },
                        new
                        {
                            Id = new Guid("a35339f6-ab5e-4197-825a-424a3888d7fb"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2819), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Wednesday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2820), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 8
                        },
                        new
                        {
                            Id = new Guid("3fe18c8d-cfdc-419a-a848-e07d8b383386"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2822), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Thursday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2822), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 16
                        },
                        new
                        {
                            Id = new Guid("8c6d144e-2fad-4cc2-a1ad-fe7661110f31"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2826), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Friday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2826), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 32
                        },
                        new
                        {
                            Id = new Guid("44ae543b-1c51-4e79-81f0-e1d99e274162"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2837), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Saturday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2838), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 64
                        },
                        new
                        {
                            Id = new Guid("3c2e8836-3745-451b-826d-da952513e0a6"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2840), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Sunday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 12, 19, 17, 25, 4, 466, DateTimeKind.Unspecified).AddTicks(2841), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 1
                        });
                });
