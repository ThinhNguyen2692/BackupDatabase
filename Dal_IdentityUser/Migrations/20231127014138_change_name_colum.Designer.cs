...
namespace DalBackup.Migrations
{
    ...
    [Migration("20231127014138_change_name_colum")]
    partial class change_name_colum
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DalBackup.Data.AdminLayout_VuexyUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "edee3d68-edbd-4ebe-957d-d3457d7bf872",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fab3ab3d-bbf1-4faa-b536-590c0422abce",
                            Email = "thinh.nguyenngoc@vnresource.org",
                            EmailConfirmed = false,
                            LockoutEnabled = true,
                            NormalizedEmail = "THINH.NGUYENNGOC@VNRESOURCE.ORG",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEItT0LPjvDGYa5LsqHok+jGWKLcVX3bmBzblc7lKeLzmdP70VrK6XYSyoVs3qec8EA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c13c91e5-4829-4cae-9acd-a2488b70cb54",
            ...
            modelBuilder.Entity("ModelProject.Models.Enum.Weekly", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9746), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Monday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9776), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 2
                        },
                        new
                        {
                            Id = new Guid("a1907086-a621-4a7f-9784-fe7a65a9b01a"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9782), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Tuesday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9782), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 4
                        },
                        new
                        {
                            Id = new Guid("a35339f6-ab5e-4197-825a-424a3888d7fb"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9786), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Wednesday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9786), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 8
                        },
                        new
                        {
                            Id = new Guid("3fe18c8d-cfdc-419a-a848-e07d8b383386"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9789), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Thursday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9789), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 16
                        },
                        new
                        {
                            Id = new Guid("8c6d144e-2fad-4cc2-a1ad-fe7661110f31"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9792), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Friday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9793), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 32
                        },
                        new
                        {
                            Id = new Guid("44ae543b-1c51-4e79-81f0-e1d99e274162"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9804), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Saturday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9805), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 64
                        },
                        new
                        {
                            Id = new Guid("3c2e8836-3745-451b-826d-da952513e0a6"),
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9807), new TimeSpan(0, 7, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Sunday",
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 11, 27, 8, 41, 38, 7, DateTimeKind.Unspecified).AddTicks(9808), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = 1
                        });
                });
