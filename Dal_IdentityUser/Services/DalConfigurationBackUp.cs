...
namespace DalBackup.Services
{
	public class DalConfigurationBackUp : IDalConfigurationBackUp
	{
		...
		private IRepository<ScheduleBackup> repositoryScheduleBackup;
		private IRepository<EmailConfirmation> repositoryEmailConfirmation;
		private IRepository<FTPSetting> repositoryFTPSetting;
		private IRepository<BackUpSetting> repositoryBackUpSetting;
		...
		public DalConfigurationBackUp(IUnitOfWork uniOfWork)
		{
			...
			repositoryScheduleBackup = _uniOfWork.Repository<ScheduleBackup>();
			repositoryFTPSetting = _uniOfWork.Repository<FTPSetting>();
			repositoryEmailConfirmation = _uniOfWork.Repository<EmailConfirmation>();
			repositoryBackUpSetting = _uniOfWork.Repository<BackUpSetting>();
		}
		...
		public ConfigurationBackUp AddOrUpdate(ConfigurationBackUp model)
		{
			try
			{
				model.DatabaseConnectId = Guid.Parse("24E1E21E-6CCB-4475-87A5-16BD0917762D");
