...
namespace ModelProject.Models
{
    public static class StringSql
    {
        ...
        public const string SQlBackupDemo = "BackupDemo @DatabaseName , @BackupName , @BackupType, @BackupPath , @enabled, @Occurs_freq_type, @freq_relative_interval_parameters, @Day_Recurs_every , @freq_recurrence_factor1, @start_date , @end_date, @start_time, @IsenabledJob,@freqSubdayType ,@freqSubdayInterval,@end_time";
